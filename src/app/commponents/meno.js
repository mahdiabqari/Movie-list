...
export default function Meno(){
    return( 
        <div className="menoo flex md:hidden flex-col h-[41rem] gap-7 justify-center items-center bg-[#D9D9D9] w-[25%] py-12 rounded-xl">
            <div className="flex flex-col justify-center items-center w-full gap-10">    
                <Link href='./' className="button cursor-pointer gap-7 flex justify-center items-center w-[80%] py-2 rounded-2xl bg-[#5D5D5D]">
                    ...
                    <h1 className="text-2xl text-[#D9D9D9] font-bold w-[60%]">Marvel</h1>
                </Link>
